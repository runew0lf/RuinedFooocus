...
RESULT=python_embeded_$VERSION
DL=dl
...
(wine $RESULT/python.exe $RESULT/get-pip.py)
(wine $RESULT/Scripts/pip.exe install wheel packaging pygit2 setuptools==80.9.0 cffi==2.0.0)
